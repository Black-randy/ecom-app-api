          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                Willow Tree (Pvt) Ltd. has been creating personalized spaces with custom furniture and interior design services since 1985.
                </p>
                <p className="flex items-center text-sm font-medium text-dark dark:text-white">
                  ...
                  <span>+094 (111) 555 033</span>
                </p>
              </div>
            </div>

            <LinkGroup header="Products">
              <NavLink link="/furniture" label="Designer Furniture" />
              <NavLink link="/artifacts" label="Artifacts" />
              <NavLink link="/art" label="Art" />
              <NavLink link="/decor" label="Home Decor" />
              <NavLink link="/accessories" label="Accessories" />
            </LinkGroup>
