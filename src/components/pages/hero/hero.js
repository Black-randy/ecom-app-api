            ...
            <div className="w-full px-4 lg:w-5/12">
              <div className="hero-content">
                <h1 className="mb-5 text-4xl font-bold !leading-[1.208] text-dark dark:text-white sm:text-[42px] lg:text-[40px] xl:text-5xl">
                  Transform Your Space with Willow Tree Interiors
                </h1>
                <p className="mb-8 max-w-[480px] text-base text-body-color dark:text-dark-6">
                  Since 1985, Willow Tree (Pvt) Ltd. has been dedicated to
                  creating unique and personalized spaces for each client.
                  Explore our custom furniture designs, interior consultations,
                  and curated decor collections to bring your vision to life.
                </p>
